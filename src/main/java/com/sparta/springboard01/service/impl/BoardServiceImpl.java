...
public class BoardServiceImpl implements BoardService {
     ...
     * dto가 어떻게 생겼는지 어떻게 작동하는지 엔티티가 알 필요가 없다고 생각을 했습니다. 그래서 서비스에서 dto 내용을 꺼내어 직접 넣어주는 방식으로 했습니다.
     */
    @Override
    ...
    @Override
    public boolean checkPassword(Long bno, BoardRequestDTO boardRequestDTO) {
        Optional<Board> result = boardRepository.findById(bno);
        Board board = result.orElseThrow();
